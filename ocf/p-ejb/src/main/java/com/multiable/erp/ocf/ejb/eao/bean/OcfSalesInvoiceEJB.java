...
import com.multiable.erp.ocf.share.interfaces.local.OcfSalesInvoiceLocal;

@Stateless(name = OcfEJB.OcfSalesInvoiceEJB)
@Local({ OcfSalesInvoiceLocal.class })
public class OcfSalesInvoiceEJB implements OcfSalesInvoiceLocal {
	@Override
